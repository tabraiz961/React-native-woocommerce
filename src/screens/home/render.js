...
import { View, FlatList, TextInput, TouchableOpacity, RefreshControl, Image, ImageBackground,Pressable, Text  } from 'react-native';
  ...
  return (
    <Container>
      ...
      <View style={[cStyles.flex_wrap,cStyles.column_align_start, cStyles.column, {height:450}]}>
        <Pressable style={[{marginHorizontal:17, marginVertical:10}]}>
